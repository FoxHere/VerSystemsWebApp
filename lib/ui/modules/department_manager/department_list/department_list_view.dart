...
class _DepartmentListViewState extends State<DepartmentListView> with MessageViewMixin, ResponsiveDeviceMixin {
  ...
  void _showDetails(BuildContext context, DepartmentModel department) {
    showOverlay(
      context,
      SheetConfiguration(
        anchor: LinkedAnchor(#depDetailsSheet),
        builder: (context) {
  ...
  Widget build(BuildContext context) {
    ...
    return OverlayAnchor(
      anchor: #depDetailsSheet,
      child: FxAppListWidget<DepartmentModel>(
        ...
        showStatusTab: true,
        statusList: [
          DepartmentStatusVisual(DepartmentStatusEnum.active),
          DepartmentStatusVisual(DepartmentStatusEnum.inactive),
        ],
