...
class _CompanyListViewState extends State<CompanyListView> with MessageViewMixin, ResponsiveDeviceMixin {
  ...
  void _showDetails(BuildContext context, CompanyModel company) {
    showOverlay(
      ...
      SheetConfiguration(
        ...
        anchor: LinkedAnchor(#companyDetailsSheet),
        builder: (_) {
  ...
  Widget build(BuildContext context) {
    ...
    return OverlayAnchor(
      anchor: #companyDetailsSheet,
      child: FxAppListWidget<CompanyModel>(
        ...
        listTitle: 'Minhas Filiais',
        listSubtitle: 'Gerencie as suas filiais',
        newItemLabel: 'Nova Filial',
        searchHint: 'Buscar filial...',
        ...
        columns: [
          ...
          AppTableColumnActions(
            ...
            dataSelector: (item) => [
              ...
              AppTableColumnActionPress(
                label: 'Excluir',
                onPressed: (context) => viewModel.deleteCompany(item.id),
